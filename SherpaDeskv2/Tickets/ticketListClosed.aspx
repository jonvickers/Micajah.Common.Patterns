<%@ Page Title="" Language="C#" MasterPageFile="~/SherpaDeskv2/SherpaDeskv2.Master" AutoEventWireup="true" CodeBehind="ticketListClosed.aspx.cs" Inherits="MCPatterns.SherpaDeskv2.Tickets.ticketListClosed" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="subMenu" runat="server">
    ...
    <div class="top-nav sub-nav">
        <div class="wrapper">
            <ul>
                <li><a href="ticketList.aspx">All Open</a></li>
                <li><a href="#">As Tech</a></li>
                <li><a href="#">As End User</a></li>
                <li><a href="#">As Alternate Tech</a></li>
                <li class="active"><a href="ticketListClosed.aspx">Closed</a></li>
...
<div class="wrapper ticket-list">
    ...
    <table class="ticket-list">
        ...
        <tbody>
            <!-----------------------------------------One Ticket End----------------------------------------------------->
            <tr class="ticket-list-single-top closed">
